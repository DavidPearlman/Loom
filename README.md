...
Installation instructions: Start a new project on your prefered LLM platform. Copy/paste the contents of the "system instructions" file into the project instructions field. Upload all of the rest of the .md files into the project files. Start a chat with "." as input. Loom comes preloaded with an anchor.md that causes it to run an introduction heuristic. In order to start a new session with a new task, replace anchor.md with a new anchor.md file that states the task and calls the planning heuristic.
...
Muse will get to know you over time. It will create a schema_CW_Writer.md file that will track your identidy, projets, preferences, style, intent, and assets.
